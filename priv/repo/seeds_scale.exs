...
contact_entries = TwoWay.Repo.SeedScale.create_contact_entries(500)

# seed contacts
Repo.insert_all(Contact, contact_entries)

# get all beneficiaries ids
contact_ids = TwoWay.Contacts.list_contacts()
...
ngo_user_message_entries = TwoWay.Repo.SeedScale.create_message_entries(contact_ids, messages_list, "ngo")

# seed messages
Repo.insert_all(Message, ngo_user_message_entries)

# create message entries for beneficiaries
beneficiary_message_entries = TwoWay.Repo.SeedScale.create_message_entries(contact_ids, messages_list, "beneficiary")
